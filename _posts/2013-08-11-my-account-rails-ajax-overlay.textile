...
Which in turns renders the following partial (_user.js.erb), setting the HTML content of the overlay appropriately.
<pre><code>
# contents of 'devise/info/_user.js.erb'
<code>&lt;div class="label overlay-label"&gt;First name: <%= current_user.email %>&lt;/div&gt;</code>
