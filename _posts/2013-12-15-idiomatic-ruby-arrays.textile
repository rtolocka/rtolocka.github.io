...
def add_players(draft_picks, offseason_signings)
  team << draft_picks << offseason_signings # add consecutively.
  new_team = old_team + draft_picks         # merge the contents of the arrays.
  new_team = new_team - pre_season_cuts     # subtract the contents of the right array that are common with the left array.
end
</code>
</pre>
