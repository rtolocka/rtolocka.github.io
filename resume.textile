...
<h4>Summary</h4>
<p>
* Technology Executive with over 15 years of experience in software development and services
* 10+ years in a client-facing professional services & consulting capacity
* Expertise in a range of client industries, across commercial, non-profit, and government verticals
* Experience in management of P&L, budgets, forecasting, and financial reporting
...
* Grew revenue from approximately $200k to $750k per month across multiple accounts.
* Led and managed a professional services group; responsible for delivery of custom software project and follow-on managed service engagements.
* Directly managed P&L and budget. Responsible for hire/fire decisions as well as talent selection and evaluation.
* Served as key customer point of trust surrounding engagement success and client satisfaction.
* Led and/or assisted on sales and capture activities; worked with sales functions to shape opportunites into successful client engagements.
* Influence client engagements by strategy, influence, and negotiation.
* Won follow-on work as required to meet revenue targets. 
* Write and negotiate contracts as required.
...
* Serve as “chief project manager”, responsible for delivery processes used to successfully execute projects.
* Hire, manage, and coach project management team and capabilities; responsible for reviews and performance feedback.
* Execute and lead the staffing and planning ("traffic") function within the company.
* Adopt, upgrade, and improve internal supporting tool sets.
* Performed other software duties as required, including analysis, UX, requirements elicitation, testing, and deployment planning.
...
* Prepare SOWs, kick-off projects, communicate goals, and manage teams.
